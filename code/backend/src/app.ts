...
import { SearchController } from "./app/modules/search/search.controller.js";
...
app.get("/api/alumni/search", auth, SearchController.searchAlumni);
app.get("/api/v1/alumni/search", auth, SearchController.searchAlumni);
