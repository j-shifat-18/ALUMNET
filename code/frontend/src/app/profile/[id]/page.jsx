...
<ProtectedRoute>
  ...
  { profilePhotoModalOpen && (
      <ProfilePhotoEditModal onClose={() => setProfilePhotoModalOpen(false)} currentImage={dbUser?.profileImage} />
    )}
  { coverPhotoModalOpen && (
      <CoverPhotoEditModal onClose={() => setCoverPhotoModalOpen(false)} currentImage={dbUser?.coverImage} />
    )}
</ProtectedRoute>
  )
}
