...
const DropdownMenu = ({ children, trigger }) => {
  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="origin-top-right absolute -right-2 mt-0.5 w-72 rounded-xl shadow-xl bg-white dark:bg-zinc-900 ring-1 ring-gray-400 focus:outline-none z-50 animate-in fade-in-0 zoom-in-95 p-2" role="menu" aria-orientation="vertical">
          {children}
        </div>
      )}
    </div>
...
export default function UserProfileDropdown() {
  ...
  return (
    <div className="flex items-center justify-center font-sans p-0 sm:p-1">
      <DropdownMenu trigger={
        <button className="flex items-center space-x-2 sm:space-x-3 p-1 sm:p-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
        ...
        <div className="px-3 py-3 border-b border-zinc-200 dark:border-zinc-700">
          <div className="flex items-center space-x-3">
            <Image src={dbUser?.profileImage || placeholder} alt="USER" width={40} height={40} className="rounded-full" />
            <div>
