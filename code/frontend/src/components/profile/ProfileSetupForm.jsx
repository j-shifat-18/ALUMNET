...
import { ChevronLast, ImageUp } from "lucide-react";
import DepartmentDropdown from "@/components/profile/DepartmentDropdown";
import ProgrammeDropdown from "@/components/profile/ProgrammeDropdown";
import BatchYearDropdown from "@/components/profile/BatchYearDropdown";
import GenderDropdown from "@/components/profile/GenderDropdown";
import PreferencesMultiSelect from "@/components/profile/PreferencesMultiSelect";
...
const ProfileSetupForm = () => {
  ...
  const departmentProgrammes = {
    ...
    "Natural Sciences (NSc)": ["NSc"],
    "Business and Technology Management (BTM)": ["BBA in TM"],
  };
  ...
  const isValidSelection = () => {
    ...
    const departmentValid =
      selectedDepartment && validDepartments.includes(selectedDepartment);
    const programmeValid =
      selectedProgramme &&
      departmentProgrammes[selectedDepartment]?.includes(selectedProgramme);
      ...
      <div className="w-full max-w-md">
        ...
        <div className="signin-card bg-white dark:bg-zinc-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-none p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div
              className={`${step === 1 ? "" : "hidden"} signin-step space-y-4`}
            >
              <div className="space-y-2">
                ...
                <div className="relative flex justify-center gap-20">
                  <button
                    type="button"
                    onClick={isAlumniActive}
                    className={
                      alumniActive
                        ? "bg-transparent text-zinc-900 rounded-xl px-5 py-3 border-2 border-zinc-900"
                        : "bg-zinc-900 text-white rounded-xl px-5 py-3 hover:bg-zinc-900/90 hover:cursor-pointer"
                    }
                  >
                    ALUMNI
                  </button>
              ...
              <div className="space-y-2">
                <label>
                  Your Batch<span className="text-red-500">*</span>
                </label>
                <BatchYearDropdown
                  role={
                    alumniActive ? "ALUMNI" : studentActive ? "STUDENT" : null
                  }
                  value={selectedBatch}
              ...
              <div className="space-y-2">
                <label>
                  Your Programme<span className="text-red-500">*</span>
                </label>
                <ProgrammeDropdown
            ...
            <div
              className={`${step === 2 ? "" : "hidden"} signin-step space-y-4 relative`}
            >
              <button
                type="button"
                onClick={handleNext}
                className="absolute top-0 right-0 flex items-center justify-end hover:cursor-pointer text-zinc-900 hover:text-zinc-900/90"
              >
                Skip
            ...
            <div
              className={`${step === 3 ? "" : "hidden"} signin-step space-y-4`}
            >
            ...
            <div
              className={`${step === 4 ? "" : "hidden"} signin-step space-y-4`}
            >
              <div className="space-y-2">
                <label>
                  Are you a job holder?<span className="text-red-500">*</span>
                </label>
                <div className="relative flex justify-center gap-20">
                  <button
                    type="button"
                    ...
                    className={
                      yesActive
                        ? "bg-transparent text-zinc-900 rounded-xl px-5 py-3 hover:text-white border-2 border-zinc-900"
                        : "bg-zinc-900 text-white rounded-xl px-5 py-3 hover:bg-zinc-900/90 hover:cursor-pointer"
                    }
                  >
                    YES
                ...
                <>
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder="Your current jobplace"
                      className="signin-input w-full px-3 py-2 bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-md text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 focus:border-transparent transition-all duration-200"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder="Your current position at job"
                      className="signin-input w-full px-3 py-2 bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-md text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 focus:border-transparent transition-all duration-200"
                    />
                  </div>
                </>
              ...
              <button
                ...
                disabled={
                  (!yesActive && !noActive) ||
                  (yesActive && (!jobPlace.trim() || !jobPosition.trim()))
                }
                className="signin-button w-full bg-gray-900 dark:bg-gray-100 hover:cursor-pointer text-white dark:text-gray-900 py-2 px-4 rounded-md text-sm font-medium hover:bg-gray-800 dark:hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-100 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-black transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
            ...
            <div
              className={`${step === 5 ? "" : "hidden"} signin-step space-y-4`}
            >
              <div className="space-y-2">
            ...
            <div
              className={`${step === 6 ? "" : "hidden"} signin-step space-y-4`}
            >
          ...
          {step > 1 && (
            <button
              ...
              className="mt-4 w-full text-gray-600 dark:text-gray-400 hover:text-gray-900 hover:cursor-pointer dark:hover:text-gray-100 transition-colors text-sm font-medium flex items-center justify-center gap-2"
            >
              <ArrowLeftIcon />
